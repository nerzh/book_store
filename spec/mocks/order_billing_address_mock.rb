...
class OrderBillingAddressMock < ActiveMocker::Base
  created_with('2.0.0')
...
# _scopes.erb
  ...
  class ScopeRelation < ActiveMocker::Association
    include OrderBillingAddressMock::Scopes
  end

  def self.__new_relation__(collection)
    OrderBillingAddressMock::ScopeRelation.new(collection)
  end
